...
def identificar_pieza_por_foto(imagen_bytes):
    ...
    try:
        ...
        prompt = (
            ...
            "Fijate con atención si hay algún código o número de parte impreso, grabado o en una "
            "etiqueta sobre la pieza — suele ser una combinación de letras y números, a veces con "
            "guiones o barras. Devolvé ÚNICAMENTE un JSON válido (sin texto extra, sin markdown), "
            'con esta forma exacta: {"codigo": "...", "marca_visible": "...", "tipo_pieza": "...", '
            '"confianza": "alta/media/baja"}. Si no hay ningún código legible, dejá "codigo" como null '
            "— no inventes ni completes un código que no se vea con claridad."
        )
